...
const Footer = () => {
  ...
  const remixes = [
    "Добавьте звуки в панели",
    "Анимируйте панели с Veo 3",
    "Локализуйте на Клингонский",
    "Добавьте генератор злодеев",
    "Распечатайте копию",
    "Добавьте озвучку",
    "Создайте общую вселенную"
  ];
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-black text-white py-3 px-6 flex flex-col md:flex-row justify-between items-center z-[300] border-t-4 border-yellow-400 font-comic">
        <div className="flex items-center gap-2 text-lg md:text-xl">
            <span className="text-yellow-400 font-bold">ИДЕЯ ДЛЯ РЕМИКСА:</span>
            <span className="animate-pulse">{remixes[remixIndex]}</span>
        </div>
        <div className="flex items-center gap-4 mt-2 md:mt-0">
            <span className="text-gray-500 text-sm hidden md:inline">Сделано с Gemini</span>
        ...
        <div className={`fixed inset-0 z-[200] overflow-y-auto`}
          ...
          <div className="min-h-full flex items-center justify-center p-4 pb-32 md:pb-24">
            ...
            <div className="max-w-[900px] w-full bg-white p-4 md:p-5 rotate-1 border-[6px] border-black shadow-[12px_12px_0px_rgba(0,0,0,0.6)] text-center relative">
                ...
                <h1 className="font-comic text-5xl text-red-600 leading-none mb-1 tracking-wide inline-block mr-3" style={{textShadow: '2px 2px 0px black'}}>БЕСКОНЕЧНЫЕ</h1>
                <h1 className="font-comic text-5xl text-yellow-400 leading-none mb-4 tracking-wide inline-block" style={{textShadow: '2px 2px 0px black'}}>ГЕРОИ</h1>
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-4 text-left">
                    ...
                    <div className="flex-1 flex flex-col gap-2">
                        ...
                        <div className={`p-3 border-4 border-dashed ${props.hero ? 'border-green-500 bg-green-50' : 'border-blue-300 bg-blue-50'} transition-colors relative group`}>
                            <div className="flex justify-between items-center mb-1">
                                <p className="font-comic text-lg uppercase font-bold text-blue-900">ГЛАВНЫЙ ГЕРОЙ (ОБЯЗАТЕЛЬНО)</p>
                                {props.hero && <span className="text-green-600 font-bold font-comic text-sm animate-pulse">✓ ГОТОВО</span>}
                            </div>
                        ...
                        <div className={`p-3 border-4 border-dashed ${props.friend ? 'border-green-500 bg-green-50' : 'border-purple-300 bg-purple-50'} transition-colors`}>
                            <div className="flex justify-between items-center mb-1">
                                <p className="font-comic text-lg uppercase font-bold text-purple-900">НАПАРНИК (ОПЦИОНАЛЬНО)</p>
                                {props.friend && <span className="text-green-600 font-bold font-comic text-sm animate-pulse">✓ ГОТОВО</span>}
                            </div>
                    ...
                    <div className="flex-1 flex flex-col gap-2">
                        ...
                        <div className="bg-yellow-50 p-3 border-4 border-black h-full flex flex-col justify-between">
                            <div>
                                <div className="mb-2">
                                    <p className="font-comic text-base mb-1 font-bold text-gray-800">ЖАНР</p>
                                ...
                                <div className="mb-2">
                                    <p className="font-comic text-base mb-1 font-bold text-gray-800">ЯЗЫК</p>
                                ...
                                {props.selectedGenre === 'Свой сюжет' && (
                                    <div className="mb-2">
                                        <p className="font-comic text-base mb-1 font-bold text-gray-800">ЗАВЯЗКА</p>
                                        <textarea value={props.customPremise} onChange={(e) => props.onPremiseChange(e.target.value)} placeholder="Опишите завязку сюжета..." className="w-full p-1 border-2 border-black font-comic text-lg h-16 resize-none shadow-[3px_3px_0px_rgba(0,0,0,0.2)]" />
                                    </div>
                                )}
                            </div>
