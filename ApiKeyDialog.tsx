    ...
    <div className="fixed inset-0 z-[400] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="relative max-w-lg w-full bg-white border-[6px] border-black shadow-[16px_16px_0px_rgba(0,0,0,1)] p-8 rotate-1 animate-in fade-in zoom-in duration-300">
        ...
        <div className="bg-gray-100 border-2 border-black border-dashed p-4 mb-6 text-left relative">
             <div className="absolute -top-3 left-4 bg-black text-white px-2 font-comic text-sm uppercase">Инструктаж миссии</div>
             <p className="font-sans text-sm text-gray-800 leading-relaxed">
                Gemini 3 Pro Image Preview — это мощная модель, для работы которой требуется проект с включенным биллингом. 
                <br/>
                <a href="https://ai.google.dev/gemini-api/docs/billing" target="_blank" rel="noreferrer" className="text-blue-600 underline hover:text-blue-800 font-bold">Читать документацию &rarr;</a>
             </p>
        </div>
        ...
        >
          Разблокировать Мультивселенную
        </button>
